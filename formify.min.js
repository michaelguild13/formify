...
var inputFactory = {
  ...
  radio: function radio(input) {
    return utils.createRadio(input);
  },
  checkbox: function checkbox(input) {
    return utils.createCheckbox(input);
  },
  range: function range(input) {
    return utils.createRange(input);
  },
  select: function select(input) {
    return utils.createSelect(input);
  },
  multiselect: function multiselect(input) {
    return utils.createSelect(input, true);
  },
...
var Formify = {
  ...
  submitForm: function submitForm(method, action, callback) {
...
var utils = {
  ...
  createSelect: function createSelect(el, multiple) {
  ...
  createCheckbox: function createCheckbox(el) {
    var input = document.createElement('input'),
  ...
  createRadio: function createRadio(el) {
  ...
  createRange: function createRange(el) {
